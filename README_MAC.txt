...
4. In Finder, navigate to the folder containing the 'OtolithScripts' folder
5. Right click on the 'OtolithScripts' folder and click on 'New Terminal at Folder'
6. Enter the following command: bash initial_install.sh